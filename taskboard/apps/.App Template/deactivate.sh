...
# This script should hide the app's window(s) for the jira number and/or repo.
...
osascript -e "tell app \"System Events\" to tell process \"${app}\" to tell every ${selector} to click button 3" &>/dev/null
